...
<div class="shadow w-full relative px-4 py-10 bg-white shadow-lg rounded-md sm:p-5 mb-3 w-9/12">
    ...
    <div class="flex flex-row border-t border-solid border-light-grey-200">
        <button on:click={sendComment} class="mt-3 border-none font-medium mr-28">Media</button>
        <button on:click={sendComment} class="mt-3 border-none font-medium text-blue-600">Add a file...</button>
    </div>
</div>
